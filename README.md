...
The immutable [`v2026.07.19` release](https://github.com/vykut/landedspec-open-data/releases/tag/v2026.07.19) also publishes a complete [`landedspec-open-data-v2026.07.19.zip`](https://github.com/vykut/landedspec-open-data/releases/download/v2026.07.19/landedspec-open-data-v2026.07.19.zip) package, [`zenodo-metadata-v2026.07.19.json`](https://github.com/vykut/landedspec-open-data/releases/download/v2026.07.19/zenodo-metadata-v2026.07.19.json), and the reviewed [`datapackage.json`](https://github.com/vykut/landedspec-open-data/releases/download/v2026.07.19/datapackage.json) descriptor as a separate deposit file. The ZIP preserves the tagged dataset state; the descriptor supplies machine-readable Data Package v2 schemas, missing-value rules, primary keys, hashes, licenses, and source metadata for the same three immutable CSV assets. The Zenodo metadata uses the `dataset` resource type, `cc-by-4.0` license identifier, the three authoritative LandedSpec landing pages, the immutable GitHub release, and the Software Heritage content identifier. It validates against Zenodo's published legacy deposit schema.
